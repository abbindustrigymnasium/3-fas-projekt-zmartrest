...
class HealthMonitorSystem {
  ...
  final _rmssdBaselineController = StreamController<double>.broadcast();
  ...
  Stream<double> get baselineStream => _rmssdBaselineController.stream;
  ...
  void processHeartRateData(double hr) {
  ...
  void processRmssdData(double rmssd) {
    ...
    // Update baseline during normal state
  ...
  */
  ...
  void _updateBaselineRmssd(double rmssd) {
    ...
    _rmssdBaselineController.add(_rmssdBaseline!);
